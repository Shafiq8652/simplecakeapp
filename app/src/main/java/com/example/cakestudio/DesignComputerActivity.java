...
public class DesignComputerActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_design_computer);
        getSupportActionBar().setTitle("Computer design on cake");
        ...
        Weight.add("1kg ₹500 of Computer Design on Cake");
        Weight.add("1.5kg ₹650 of Computer Design on Cake");
        Weight.add("2kg ₹750 of Computer Design on Cake");
