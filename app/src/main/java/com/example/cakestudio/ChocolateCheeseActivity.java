...
public class ChocolateCheeseActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chocolate_cheese);
        getSupportActionBar().setTitle("Chocolate cheese cake");
        ...
        Weight.add("1kg ₹400 of Chocolate Cheese Cake");
        Weight.add("1.5kg ₹500 of Chocolate Cheese Cake");
        Weight.add("2kg ₹700 of Chocolate Cheese Cake");
