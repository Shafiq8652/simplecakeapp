...
public class RedVelvetCupcakeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_red_velvet_cupcake);
        getSupportActionBar().setTitle("Red Velvet Cupcake");
        ...
        Weight.add("5 piece: ₹200 of Red velvet special cake");
        Weight.add("10 piece: ₹400 of Red velvet special cake");
        Weight.add("20 piece: ₹700 of Red velvet special cake");
