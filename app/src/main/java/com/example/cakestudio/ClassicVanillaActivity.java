...
public class ClassicVanillaActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classic_vanilla);
        getSupportActionBar().setTitle("Classic Vanilla cake");
        ...
        Weight.add("1kg ₹350 of Classic Vanilla Cake");
        Weight.add("1.5kg ₹450 of Classic Vanilla Cake");
        Weight.add("2kg ₹600 of Classic Vanilla Cake");
