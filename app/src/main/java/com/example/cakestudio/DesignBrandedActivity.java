...
public class DesignBrandedActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_design_branded);
        getSupportActionBar().setTitle("Logo of gucci design on cake");
        ...
        Weight.add("1kg ₹600 of logo of Gucci Design Cake");
        Weight.add("1.5kg ₹750 of logo of Gucci Design Cake");
        Weight.add("2kg ₹900 of logo of Gucci Design Cake");
