...
public class MangocakeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mangocake);
        getSupportActionBar().setTitle("Mango cake");
        ...
        Weight.add("1kg ₹550 of Mango Cake");
        Weight.add("1.5kg ₹650 of Mango Cake");
        Weight.add("2kg ₹750 of Mango Cake");
