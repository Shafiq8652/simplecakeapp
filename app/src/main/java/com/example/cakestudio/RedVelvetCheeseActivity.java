...
public class RedVelvetCheeseActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_red_velvet_cheese);
        getSupportActionBar().setTitle("Red Velvet Cheese cake");
