...
public class ChocolateRaspberryActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chocolate_raspberry);
        getSupportActionBar().setTitle("Chocolate Raspberry cake");
        ...
        Weight.add("1kg ₹400 of Chocolate Raspberry Cake");
        Weight.add("1.5kg ₹500 of Chocolate Raspberry Cake");
        Weight.add("2kg ₹700 of Chocolate Raspberry Cake");
