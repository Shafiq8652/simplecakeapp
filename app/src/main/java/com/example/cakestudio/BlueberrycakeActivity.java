...
public class BlueberrycakeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blueberrycake);
        getSupportActionBar().setTitle("Blueberry cake");
        ...
        Weight.add("1kg ₹400 of Blueberry cake");
        Weight.add("1.5kg ₹550 of Blueberry cake");
        Weight.add("2kg ₹700 of Blueberry cake");
