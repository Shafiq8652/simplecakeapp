...
public class RedVellvetSpecialActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_red_vellvet_special);
        getSupportActionBar().setTitle("Red Velvet Special cake");
        ...
        Weight.add("1kg ₹400 of Red velvet special cake");
        Weight.add("1.5kg ₹550 of Red velvet special cake");
        Weight.add("2kg ₹700 of Red velvet special cake");
