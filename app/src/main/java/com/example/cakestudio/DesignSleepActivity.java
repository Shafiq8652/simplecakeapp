...
public class DesignSleepActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_design_sleep);
        getSupportActionBar().setTitle("Sleeping Bed design on cake");
        ...
        Weight.add("1kg ₹450 of Sleeping bed Design on Cake");
        Weight.add("1.5kg ₹550 of Sleeping bed Design on Cake");
        Weight.add("2kg ₹700 of Sleeping bed Design on Cake");
