...
public class GoldenVanillaActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_golden_vanilla);
        getSupportActionBar().setTitle("Golden Vanilla cake");
        ...
        Weight.add("1kg ₹400 of Golden Vanilla Cake");
        Weight.add("1.5kg ₹550 of Golden Vanilla Cake");
        Weight.add("2kg ₹700 of Golden Vanilla Cake");
