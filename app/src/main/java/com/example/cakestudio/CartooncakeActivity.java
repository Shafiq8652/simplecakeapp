...
public class CartooncakeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cartooncake);
        getSupportActionBar().setTitle("Cartoon cake");
        ...
        Weight.add("1kg ₹450 of Cartoon cake");
        Weight.add("1.5kg ₹550 of Cartoon cake");
        Weight.add("2kg ₹700 of Cartoon cake" );
