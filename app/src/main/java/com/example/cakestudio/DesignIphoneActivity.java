...
public class DesignIphoneActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_design_iphone);
        getSupportActionBar().setTitle("Iphone design on cake");
        ...
        Weight.add("1kg ₹400 of Iphone Design on Cake");
        Weight.add("1.5kg ₹550 of Iphone Design on Cake");
        Weight.add("2kg ₹700 of Iphone Design on Cake");
