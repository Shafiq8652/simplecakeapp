...
public class PineapplecakeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pineapplecake);
        getSupportActionBar().setTitle("Pineapple cake");
        ...
        Weight.add("1kg ₹400 of Pineapple Cake");
        Weight.add("1.5kg ₹550 of Pineapple cake");
        Weight.add("2kg ₹700 of Pineapple cake");
