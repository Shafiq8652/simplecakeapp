...
public class BlackForestActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    Spinner spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Black Forest cake");
        ...
        Weight.add("1kg ₹400 of Black Forest Cake");
        Weight.add("1.5kg ₹500 of Black Forest Cake");
        Weight.add("2kg ₹700 of Black Forest Cake");
