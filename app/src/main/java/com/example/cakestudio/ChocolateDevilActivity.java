...
public class ChocolateDevilActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chocolate_devil);
        getSupportActionBar().setTitle("Chocolate devil cake");
        ...
        Weight.add("1kg ₹400 of Chocolate Devil Cake ");
        Weight.add("1.5kg ₹500 of Chocolate Devil Cake ");
        Weight.add("2kg ₹700 of Chocolate Devil Cake ");
