...
public class DesignMakeupActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_design_makeup);
        getSupportActionBar().setTitle("Makeup set design on cake");
        ...
        Weight.add("1kg ₹500 of Makeup set Design Cake");
        Weight.add("1.5kg ₹650 of Makeup set Design Cake");
        Weight.add("2kg ₹800 of Makeup set Design Cake");
