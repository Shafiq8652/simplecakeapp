...
public class DesignSocialActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_design_social);
        getSupportActionBar().setTitle("Social Media design on cake");
        ...
        Weight.add("1kg ₹1000 of Social media Design on Cake");
        Weight.add("1.5kg ₹1550 of Social media Design on Cake");
        Weight.add("2kg ₹1700 of Social media Design on Cake");
