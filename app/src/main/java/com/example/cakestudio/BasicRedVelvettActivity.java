...
public class BasicRedVelvettActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Spinner spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_red_velvett);
        getSupportActionBar().setTitle("Basic Red Velvet cake");
        ...
        Weight.add("1kg ₹450 of Basic Red velvet cake");
        Weight.add("1.5kg ₹550 of Basic Red velvet cake");
        Weight.add("2kg ₹750 of Basic Red velvet cake");
