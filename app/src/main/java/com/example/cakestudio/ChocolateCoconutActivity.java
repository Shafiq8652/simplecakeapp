...
public class ChocolateCoconutActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chocolate_coconut);
        getSupportActionBar().setTitle("Chocolate coconut cake");
        ...
        Weight.add("1kg ₹450 of Chocolate Coconut Cake");
        Weight.add("1.5kg ₹550 of Chocolate Coconut Cake");
        Weight.add("2kg ₹750 of Chocolate Coconut Cake");
