...
public class EgglessVanillaActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eggless_vanilla);
        getSupportActionBar().setTitle("Egg less Vanilla cake");
        ...
        Weight.add("1kg ₹400 of Egg less Vanilla Cake");
        Weight.add("1.5kg ₹550 of Egg less Vanilla Cake");
        Weight.add("2kg ₹700 of Egg less Vanilla Cake");
