...
public class MixfruitcakeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mixfruitcake);
        getSupportActionBar().setTitle("MixFruit cake");
        ...
        Weight.add("1kg ₹600 of Mix fruit cake");
        Weight.add("1.5kg ₹750 of Mix fruit cake");
        Weight.add("2kg ₹900 of Mix fruit cake");
