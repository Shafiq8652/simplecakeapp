...
public class CouplecakeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_couplecake);
        getSupportActionBar().setTitle("Couple cake");
        ...
        Weight.add("1kg ₹400 of Couple cake");
        Weight.add("1.5kg ₹550 of Couple cake");
        Weight.add("2kg ₹650 of Couple cake");
